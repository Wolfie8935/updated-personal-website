...
export function Projects() {
  const projects = [
    ...
    },
    {
      ...
      tag: "Minor Project",
      description: "Machine learning pipeline designed to predict cyclone intensity using large scale meteorological data.",
      features: [
    ...
    },
    {
      ...
      description: "LLM-powered chatbot pipeline built using ETL preprocessing, tokenization workflows, and LLaMA-based inference models.",
      features: [
      ...
      tech: ["LLaMA", "Intel Extension for Transformers", "ETL", "Python"],
      featured: false
    },
    {
      id: "portfolio",
      title: "Personal Website",
      description: "Elite, high-impact personal portfolio designed to communicate the profile of a serious AI/ML engineer and researcher.",
      features: [
        "Dark technical minimal aesthetic",
        "WebGL Particle Network background",
