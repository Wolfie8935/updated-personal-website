...
/**
 * WizardingHome — the original portfolio layout, rendered only for the wizarding theme.
 *
 * This is a verbatim move of the previous Home.tsx. The wizarding experience depends on
 * these exact shared components and conditional effects; do not alter this file when
 * working on the modern (dark/light) redesign.
 */
export function WizardingHome() {
  const isWizarding = true;
